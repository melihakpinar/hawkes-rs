//! `hawk` side of the M4 simulate benchmark. See `benchmarks/README.md`.
//!
...
use hawk::multivariate::{Parameters, simulate};
...
fn main() {
    ...
    let body = format!(
        r#"{{"library":"hawk","benchmark":"simulate","dimension":{d},"seed":{SEED},"warmup":{WARMUP},"timed":{TIMED},"true_baseline":{},"true_excitation":{},"true_decay":{DECAY:?},"runs":[{}]}}"#,
