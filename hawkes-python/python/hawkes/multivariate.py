...
Parameters = _hawkes.MultivariateParameters
Fit = _hawkes.MultivariateFit
...
def negative_log_likelihood(
    ...
    """
    return _hawkes.multivariate_negative_log_likelihood(parameters, events, horizon)
...
def negative_log_likelihood_and_gradient(
    ...
    value, baseline, excitation, decay = (
        _hawkes.multivariate_negative_log_likelihood_and_gradient(parameters, events, horizon)
    )
...
def compensator_at_events(
    ...
    """
    return _hawkes.multivariate_compensator_at_events(parameters, events, horizon)
...
def simulate(parameters: Parameters, horizon: float, seed: int) -> Events:
    ...
    """
    return _hawkes.multivariate_simulate(parameters, horizon, seed)
...
def fit(events: Events, horizon: float) -> Fit:
    ...
    """
    return _hawkes.multivariate_fit(events, horizon)
