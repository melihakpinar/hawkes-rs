...
The comparison is against ``tests/fixtures/rust-nll.json``, which records what ``hawk``
computes in Rust as an exact bit pattern, and which ``hawk/tests/rust_nll_manifest.rs``
